<template>
  <div>
    ...
    <el-dialog :title="title" :visible.sync="open" :width="width" ref="AvatarDialog">
      <el-row>
      ...
      <el-row style="margin-top: 10px;" type="flex" justify="center">
        <el-col :lg="{span: 2, offset: 6}" :md="2" :xs="6">
...
<script>
  ...
  export default {
    ...
    //     this.$refs.AvatarDialog.style.width = (clientWidth - 20) + 'px'
    //   }
    // },
    methods: {
      // 编辑头像
